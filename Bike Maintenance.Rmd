...
In order to **<span style='color:brown;'>provide a good service</span>** for the users of the bike sharing scheme, **<span style='color:brown;'>unavailability needs to be avoided</span>**, either by lack of maintenance or lack of supply. Thus, maintenance windows need to be selected **<span style='color:brown;'>smartly</span>**.
...
- There is **<span style='color:brown;'>some seasonality</span>** in the demand: registered users brave through the winter keeping a the numbers high.
